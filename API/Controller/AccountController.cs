...
namespace API.Controller
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDto>> Login(LoginDto loginDto)
        {
            ...
            // Because seeded accounts doesnt have a valid email
            if (user.UserName == "bob") user.EmailConfirmed = true;
            if (user.UserName == "tom") user.EmailConfirmed = true;
            if (user.UserName == "jane") user.EmailConfirmed = true;
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            var verifiyUrl = $"{origin}/account/verifyEmail?token={token}&email={user.Email}";
